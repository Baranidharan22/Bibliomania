...
if (isset($_POST['query'])) {
  ...
  $query = "SELECT * FROM bookimage WHERE   CONCAT(bname, author) LIKE '%$filtervalues%'  order by bid desc limit 10  ";
  $query_run = mysqli_query($con, $query);
} else {
  $query = "SELECT * FROM bookimage order by bid desc limit 10";
  $query_run = mysqli_query($con, $query);
}
?>
<!DOCTYPE html>
