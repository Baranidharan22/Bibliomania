...
<?php
$id = $_SESSION['id'];
$quer1 = "SELECT * FROM profile where user_id = '$id' ";
$quer_run1 = mysqli_query($con,$quer1);
if(mysqli_num_rows($quer_run1) == 0){
$x = "No";
$quer = "INSERT INTO profile (`user_id`,`private`) values('$id','$x')";
...
<body>
  ...
  <div class="cart">
      ...
      <a href="http://localhost/phpscripts/test.php"><span id="x">&times;</span></a><input type="submit" value="Search"/>
    </form>
  </div>
  <div id="main">
...
?> 
  ...
  ?>
    <table class="book-info">
      <tr>
        <td>
          <img title="<?php echo $row["bname"];?>" src="<?php echo $row["image"]; ?>" widht='50px' height='30px' alt="" />
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <center>
            <form method="POST">
                ...
                <input class="nike" type="submit"  value="View" name="view-button" />
